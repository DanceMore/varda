...
impl Channel {
    ...
    pub fn render(
        ...
        // Composite all decks using a ping-pong strategy to avoid redundant texture copies.
        // For each deck after the first, we blend the current deck with the composite-so-far
        // and write the result into the alternate texture.
